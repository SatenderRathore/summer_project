                    ...
                    <form id="availability" action="../backend/algo/check_seat_availability.php" method="POST">
                        <div class="mid-content">
                            ...
                            <div class="dest " id="destn">
                                <div class="details">
                                    <fieldset data-form-name="dest" data-step="1" >
                            ...
                            <div class="date" id="date">
                                <div class="details">
                                    <fieldset data-form-name="date" data-step="1" >
                                        <legend> Enter Date Of Journey</legend>
                                        <input class="date-picker form-control" name="doj" type="text" id="datepicker" data-type="text" data-required="true">
                                        <label class="number-error error-msg"></label>
                                    </fieldset>
                                </div>
                                <span class="submit">
                            ...
                            <div class="selclass" id="selclass">
                                <div class="details">
                                    <fieldset data-form-name="selclass" data-step="1" >
                            ...
                            <div class="quota" id="quota">
                                <div class="details">
                                    <fieldset data-form-name="quota" data-step="1" >
                                ...
                                <span class="submit">
                                    ...
                                    <button name="action" value="Find Trains"><img src="../images/next.png" alt="Submit"></button>
                                </span>
                            </div>
