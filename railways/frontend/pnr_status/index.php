...
<script>
// //------------------------------wrong code to display alternate option button in any of current status in not confirm------------
// 		   var current_status;
...
//------------------------------Right code to display alternate option button in any of current status in not confirm------------
		var current_status;
        var totalPassengers = '<?php echo count($passengers)?>';
